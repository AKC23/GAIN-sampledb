...
// SQL query to drop the 'measure_unit2' table if it exists
$dropTableSQL = "DROP TABLE IF EXISTS measure_unit2";

// Execute the query to drop the table
if ($conn->query($dropTableSQL) === TRUE) {
    echo "Table 'measure_unit2' dropped successfully.<br>";
} else {
    echo "Error dropping table 'measure_unit2': " . $conn->error . "<br>";
}

// SQL query to create the 'measure_unit2' table
$createTableSQL = "
    CREATE TABLE measure_unit2 (
...
if ($conn->query($createTableSQL) === TRUE) {
    echo "Table 'measure_unit2' created successfully.<br>";
} else {
    echo "Error creating table: " . $conn->error . "<br>";
}

// Path to your CSV file
$csvFile = 'data/measure_unit2.csv';  // Update with the exact path of your CSV file
...
if (($handle = fopen($csvFile, "r")) !== FALSE) {
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        ...
        $sql = "INSERT INTO measure_unit2 (UnitSelection, UnitValue) VALUES (?, ?)";
    ...
    echo "<br>Final measure_unit2 table contents:<br>";
    $result = $conn->query("SELECT * FROM measure_unit2 ORDER BY UnitID");
    if ($result) {
