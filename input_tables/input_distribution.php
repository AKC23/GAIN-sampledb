...
<body>
    <div class="container mt-5">
        ...
        <form method="post" action="input_distribution.php" class="mb-4" onsubmit="return validateYears()">
        ...
        <?php if (isset($_GET['action']) && $_GET['action'] === 'edit' && isset($_GET['id'])): ?>
            ...
            ?>
                ...
                <form method="post" action="input_distribution.php" class="mb-4" onsubmit="return validateYears()">
                    ...
                    <label for="Volume_MT_Y">Volume (MT/Y):</label>
                    <input type="text" id="Volume_MT_YEdit" class="form-control" readonly value="<?= htmlspecialchars(number_format($row['Volume_MT_Y'], 6)) ?>"><br>
    ...
    <script>
        ...
        function computeVolume() {
            ...
            document.getElementById('Volume_MT_Y').value = volume ? volume.toFixed(6) : '';
        }
